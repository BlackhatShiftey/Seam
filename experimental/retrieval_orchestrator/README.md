...
- the SQLite leg now pushes field filters, lexical gating, and ranking into SQL instead of relying on a weak in-memory pass
...
2. Evaluate machine-facing retrieval projections without making vector stores canonical.
