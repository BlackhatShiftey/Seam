...
from .types import HybridSearchResult, RAGResult, RetrievalPlan
...
class HybridOrchestrator:
    ...
    def search(self, query: str, scope: str | None = None, budget: int = 5, include_trace: bool = False) -> HybridSearchResult:
