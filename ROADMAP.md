...
Track I (external memory benchmarks) and Track H (Skills Compiler) consume Track K primitives in their later phases.
...
- I1: External memory benchmark registry + runner (reconcile from `bench/add-memory-benchmark-registry`)
