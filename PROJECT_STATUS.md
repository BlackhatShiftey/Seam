...
Last updated: 2026-05-29 (HISTORY#270 - SQLite concurrency-layer hardening: pool off-lock validation + blocking-path validation (F3/F4), retry_db_operation wired onto the six write methods (F2); follows HISTORY#269 audit slice)
