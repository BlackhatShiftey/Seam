...
- Dashboard redesign P0 polish on `SEAM-CC/elated-cartwright-8313cf`: RichLog-backed colored Overview/MIRL/Runtime panels, runtime-smoked Settings API apply flow, and ExplorerTree namespace/scope lazy-load
...
- Textual dashboard (interactive TUI, chat, slash palette, reload command, MIRL animation, independent pane scrolling, colored Rich markup panels, namespace-aware explorer)
