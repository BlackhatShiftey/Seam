...
- GitHub PR state as of 2026-05-16: PRs #22, #18, and #23 are all merged into main (commits `458eca8`, `b059cdb`, `c9bfe2a`). PR #19 is still draft, conflicting, and must be treated as a partial extraction source because its branch contains private-session-link material in commit metadata. No other PRs are open. Merged PR branches should not be treated as active work just because their remote branch refs may still exist.
