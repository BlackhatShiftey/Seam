...
Last updated: 2026-05-28 (HISTORY#268 - completed unrecorded Qwen hardening: ShutdownState/Middleware, shell command allowlist, SQLite connection pool with check_same_thread, restored composite case_id, Cut-off Recovery rule, QWEN.md)
